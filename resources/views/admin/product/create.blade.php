    ...
    <div class="card-body bg-light">
      <div class="tab-content">
        ...
        <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label class="form-label" for="name">Name</label><input class="form-control" id="name" type="text" name="name" placeholder="Name" value="{{ old('name') }}">
                @error('name')
            ...
            <div class="mb-3">
                <label class="form-label" for="details">Details</label><input class="form-control" id="details" type="text" name="details" placeholder="Details" value="{{ old('details') }}">
                @error('details')
                <div class="alert alert-danger alert-dismissible fade show mt-3">
                    <div class="mt-2 text-danger">{{ $message }}</div>
                </div>
            ...
            <div class="mb-3">
                <label class="form-label" for="details">Price</label><input class="form-control" id="price" type="text" name="price" placeholder="Price" value="{{ old('price') }}">
                @error('price')
                <div class="alert alert-danger alert-dismissible fade show mt-3">
                    <div class="mt-2 text-danger">{{ $message }}</div>
                </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="categories" id="categories" aria-label="Default select example">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description" name="description" rows="3" placeholder="Description" value="{{ old('description') }}">
                </textarea>
                @error('description')
                <div class="alert alert-danger alert-dismissible fade show mt-3">
                    <div class="mt-2 text-danger">{{ $message }}</div>
